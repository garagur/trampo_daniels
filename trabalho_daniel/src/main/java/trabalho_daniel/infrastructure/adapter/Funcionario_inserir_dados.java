package trabalho_daniel.infrastructure.adapter;

import java.util.List;

import trabalho_daniel.application.usecases.servico_rh;
import trabalho_daniel.domain.entities.Funcionario_construtor;
import trabalho_daniel.domain.entities.trabalho_devSenior;
import trabalho_daniel.domain.entities.trabalho_devjunior;
import trabalho_daniel.domain.entities.desconto_INSS26;
import trabalho_daniel.domain.entities.desconto_imposto_generico26;
import trabalho_daniel.domain.entities.desconto_horas;
import trabalho_daniel.domain.entities.acrecimo_horas;
